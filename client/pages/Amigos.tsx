export default function Amigos() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto text-center px-6 mt-3">
      <p className="mt-3 leading-relaxed text-white/80 text-base sm:text-lg md:text-xl font-medium tracking-wide [font-family:'Playfair Display',serif]">
        {subtitle}
      </p>
      ...
      <div className="mt-8">
        <a
          ...
          className="inline-flex items-center justify-center gap-3 rounded-full border border-white/20 text-white px-6 py-3 transition-colors duration-300 ease-out hover:border-white/40 hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30 text-sm tracking-wide"
        >
