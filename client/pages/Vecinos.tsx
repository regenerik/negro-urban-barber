...
export default function Vecinos() {
  ...
  const subtitle = "Para nosotros los vecinos son sagrados";
  const subtitle2 = "Y queremos que con nosotros, te sientas como en casa";
    ...
    >
      ...
      <div className="relative text-center py-10 px-4">
        ...
        <span className="text-white/80 font-light text-base">
          Si llegaste hasta acá, es porque te queremos siempre cerca.
        </span>
